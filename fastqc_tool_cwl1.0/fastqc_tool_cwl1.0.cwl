...
doc: |-
  **Note:** This version of the FastQC CWL 1.0 tool was created for testing purposes regarding github actions and CI/CD only. Changes vs the public tool are purely to run tests and should't affect functionality, but this version is not supported by SBG in production.
